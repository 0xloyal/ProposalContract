...
contract ProposalContract {
    ...
    function calculateCurrentState() private view returns (bool) {
        ...
        // Calculate the threshold for a passing vote percentage
        uint256 passingThreshold = (totalVotes * 70) / 100; // 70% threshold for passing

        // Check if the number of approve votes is greater than or equal to the passing threshold
        if (proposal.approve >= passingThreshold) {
